...
with open("./src/SentiCR/Contractions.txt","r") as contractions,\
     open("./src/SentiCR/EmoticonLookupTable.txt","r") as emotable:
...
def preprocess_text(text):
    ...
    comments = text.encode('ascii', 'ignore').decode('ascii', 'ignore')
...
class SentiCR:
    ...
    def create_model_from_training_data(self):
        ...
        smote_model = SMOTE(random_state=42, k_neighbors=15)
